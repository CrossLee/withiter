...
<div class="menu_nav">
<ul>
	<li class="active"><a href="index_en.jsp"><fmt:message key="home" bundle="${formBundle}" /></a></li>
...
<div class="searchform">
        <form id="formsearch" name="formsearch" method="post" action="">
          <span>语言：<a href="index.jsp">中文</a></span>
        </form>
      </div>
<div class="clr"></div>
...
<div class="clr"></div>
<br/>
<img src="images/homelogo5.jpg" width="625" height="205" alt="image" />
<br/>
<br/>
