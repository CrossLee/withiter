...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#imageField").buttonCaptcha({
			...
			captchaHeader	:	'你是机器人吗?',	// question above the Captcha;
			captchaTip		: 	'从左边拖拽相应的字符到右边，组成"%code_word%". 谢谢!', 	// tip text; remember that you must save %code_word% tag! 																								// For example : < Hello, make this word: %code_word% >
			captchaUnlocked	:	'可以提交了!'	// text for the header of captcha when it unlocked;
		});
	});
	...
	function submitMessage(){
		...
		*/
		...
		$.ajax({
			...
			dataType:"html",
			data: encodeURI($("#leavemessage").serialize()),
			success: function(data){
			$.ajax({
				type: "POST",
				url: "/withiter/getmessageAction.html",
  ...
  <div class="header">
    <div class="header_resize">
      <div class="menu_nav">
		...
		<li class="active"><a href="contact.jsp"><fmt:message key="contactus" bundle="${formBundle}" /></a></li>
        </ul>
      </div>
      <div class="clr"></div>
